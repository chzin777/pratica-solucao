...
/** Botão flutuante de WhatsApp com pulso, fixo no canto inferior direito. */
export function FloatingWhats() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-[90] flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-transform duration-200 hover:scale-110 sm:bottom-6 sm:right-6 sm:h-14 sm:w-14"
    >
      {/* Anéis de pulso */}
